const en = {
    DIALOG: {
        ...
        TAX_COMPLETE: {
            ...
            DESCRIPTION: 'Notification emails will be sent out to each lender with a loan in that tax authority.',
        ...
        DELETE_PROFILE_PICTURE: {
            ...
            DESCRIPTION: 'This will permanently delete the profile picture. Are you sure you want to continue?',
            CANCEL_ACTION: 'Cancel',
    ...
    SET_PASSWORD: {
        ...
        PASSWORD_VALIDATION: {
            ...
            AT_LEAST_1_SPECIAL_CHARACTER: 'at least one special character like @$!%*?&',
        },
    },
    LOGIN: {
        TOAST: {
        ...
        SUB_TITLE: 'Eliminate manual effort with smart document processing. Capture, organise, and retrieve data seamlessly—boosting productivity and accuracy.',
        USERNAME: 'Username',
        PASSWORD: 'Password',
        LOGIN: 'Login',
    ...
    FORGOT_PASSWORD: {
        ...
        DESCRIPTION: 'Enter your registered email to receive a link to reset password',
        EMAIL: 'Email Address',
    ...
    CHANGE_PASSWORD: {
        ...
        TOAST: {
            SUCCESS: 'Password changed successfully. All sessions have been logged out.',
        },
    },
    NAVBAR: {
        DASHBOARD: 'Dashboard',
